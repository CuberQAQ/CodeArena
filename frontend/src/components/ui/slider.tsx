...
export function Slider({
  ...
  return (
    ...
    >
      <SliderControl className="relative h-5 w-full cursor-pointer px-2">
        <SliderTrack className="absolute left-2 right-2 top-1/2 h-1.5 -translate-y-1/2 rounded-full bg-muted">
