...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('contest_session_id', postgresql.UUID(as_uuid=True), sa.ForeignKey('contest_sessions.id', ondelete='CASCADE'), nullable=False),
        sa.Column('medal_level', sa.String(30), nullable=False, comment='XCPC tier level: world_finals, ec_final, regional, provincial'),
