...
class UserTagElo(Base, UUIDPrimaryKeyMixin):
    ...
    total_submissions: Mapped[int] = mapped_column(Integer, server_default="0", nullable=False)
    first_ac_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
