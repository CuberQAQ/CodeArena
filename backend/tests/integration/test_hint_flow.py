...
class TestHintStatus:
    ...
    async def test_no_hints_unlocked(self, db_session):
        ...
        status = await HintService.get_hint_status(db_session, user, problem_id="1000A", problem_rating=1200)
...
class TestHintUnlock:
    ...
    async def test_unlock_level_1(self, db_session):
        ...
        result = await HintService.unlock_hint(db_session, user, problem_id="1000A", problem_rating=1200, level=1)
    ...
    async def test_unlock_level_2_after_level_1(self, db_session):
        ...
        await HintService.unlock_hint(db_session, user, problem_id="1000A", problem_rating=1200, level=1)
        result = await HintService.unlock_hint(db_session, user, problem_id="1000A", problem_rating=1200, level=2)
    ...
    async def test_unlock_level_3_after_levels_1_and_2(self, db_session):
        ...
        await HintService.unlock_hint(db_session, user, problem_id="1000A", problem_rating=1200, level=1)
        await HintService.unlock_hint(db_session, user, problem_id="1000A", problem_rating=1200, level=2)
        result = await HintService.unlock_hint(db_session, user, problem_id="1000A", problem_rating=1200, level=3)
    ...
    async def test_cannot_skip_level_2(self, db_session):
        ...
        with pytest.raises(Exception, match="Must unlock hint levels 1 and 2"):
            await HintService.unlock_hint(db_session, user, problem_id="1000A", problem_rating=1200, level=3)
    ...
    async def test_invalid_level_fails(self, db_session):
        ...
        with pytest.raises(Exception, match="must be 1, 2, or 3"):
            await HintService.unlock_hint(db_session, user, problem_id="1000A", problem_rating=1200, level=0)

        with pytest.raises(Exception, match="must be 1, 2, or 3"):
            await HintService.unlock_hint(db_session, user, problem_id="1000A", problem_rating=1200, level=4)
...
class TestHintContent:
    ...
    async def test_get_content_for_unlocked_level(self, db_session):
        ...
        content = await HintService.get_hint_content(db_session, user, problem_id="1000A", level=1, problem_rating=1200)
    ...
    async def test_cannot_get_content_for_locked_level(self, db_session):
        ...
        with pytest.raises(Exception, match="not unlocked"):
            await HintService.get_hint_content(db_session, user, problem_id="1000A", level=2, problem_rating=1200)
...
class TestHintHistory:
    ...
    async def test_empty_history_for_new_problem(self, db_session):
        ...
        history = await HintService.get_hint_history(db_session, user, problem_id="1000A")
